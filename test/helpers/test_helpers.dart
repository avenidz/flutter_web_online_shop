...
@GenerateMocks([], customMocks: [
  ...
  MockSpec<ApiImplService>(onMissingStub: OnMissingStub.returnDefault),
// @stacked-mock-spec
])
...
MockApiImplService getAndRegisterApiImplService() {
  _removeRegistrationIfExists<ApiImplService>();
  final service = MockApiImplService();
  locator.registerSingleton<ApiImplService>(service);
  return service;
}
// @stacked-mock-create
